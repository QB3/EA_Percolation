...
int main(int argc, const char * argv[]) {
	...
	int nkTau4=10;//100
	int nlTau4=1;
	int tabd[9] = {2, 3, 4, 5, 10, 15,16,17, 21};
	...
	if (f.is_open()){
		for( int i =0; i< tailleTab; i++){
			int d = tabd[i];
			double res2 = DeltaTau12(niTau2, njTau2, d);
			double res3 = DeltaTau23(niTau2, njTau2, niTau3, njTau3, nkTau3,d);
			double res4 = DeltaTau34(niTau2, njTau2, niTau3, njTau3, nkTau3, niTau4, njTau4, nkTau4, nlTau4, d);
			double res5 = DeltaTau45(niTau2, njTau2, niTau3, njTau3, nkTau3, niTau4, njTau4, nkTau4, nlTau4, ni, nj, nk, nl,nm, d);
			cout << "d = " << d  << " ni = " << ni << " nj = " << nj << " nk = "<< nk << " nl = " << nl << endl;
			cout.precision(4);
			f <<  d << " & " <<  0.3313/sqrt(d)  << " & " << res2 << " & " << res3<< " & " << res4 << " & " << res5 <<  "\\" << "\\" << endl;
	    }
	    f.close();
	}
